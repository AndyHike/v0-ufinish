...
export async function POST(request: Request) {
  try {
    ...
    // Handle both formats: direct brands array or brandId + direction
    ...
    } else if (body.brandId && body.direction) {
      // Handle single brand move up/down
      const { brandId, direction } = body
