...
export function ModelsList({ brandId, seriesId }: ModelsListProps) {
  ...
  const [selectedSeriesFilter, setSelectedSeriesFilter] = useState<string>(seriesId || "")
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    {!seriesId && <TableHead>{t("series") || "Series"}</TableHead>}
                          ...
                          >
                            {(provided) => (
                              <TableRow ref={provided.innerRef} {...provided.draggableProps}>
                                ...
                                {!brandId && <TableCell>{model.brands?.name}</TableCell>}
                                {!seriesId && (
