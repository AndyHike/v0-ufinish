export async function getMessages(locale: string) {
  return {
    ...
    Footer: {
      ...
      allRightsReserved:
        locale === "uk" ? "Всі права захищені." : locale === "cs" ? "Všechna práva vyhrazena." : "All rights reserved.",
    },
    UserNav: {
    ...
    Contact: {
      ...
      messagePlaceholder:
        locale === "uk" ? "Введіть ваше повідомлення" : locale === "cs" ? "Zadejte svou zprávu" : "Enter your message",
